...
def test_transaction_descriptions(data):
    ...
    run_func_test = transaction_descriptions(transactions)

    for piece in test_list:
        description = next(run_func_test)
        assert description == piece
