...
На данном этапе общая логика и функционал реализованны в модуле __main__
...
8. Модуль __transactions_search__ 
    * filter_transactions
       * Поиск совпадений по введённым данным.
    * filter_category_transactions
...
* __Пакет tests__
    ...
    * test_transactions_search - Тесты модуля src.transactions_search
...
Реализована запись логов в файл logs.log
